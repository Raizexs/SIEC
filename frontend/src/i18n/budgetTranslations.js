...
export const budgetTranslationsEs = {
  ...
  budgetLoadingHint: "Consultamos el motor de costos y precios de mercado en tiempo real.",
  budgetLoadingProgress: "Progreso",
  budgetLoadingEta: "Aprox. {seconds}s restantes",
  budgetLoadingAlmostDone: "Casi listo…",
  budgetLoadingStepSim: "Preparando simulación estructural…",
  budgetLoadingStepSupplies: "Cotizando insumos y materiales…",
  budgetLoadingStepNormativa: "Validando normativa del diseño…",
  budgetLoadingStepSimShort: "Simulación estructural",
  budgetLoadingStepSuppliesShort: "Insumos y precios de mercado",
  budgetLoadingStepNormativaShort: "Validación normativa",
...
export const budgetTranslationsEn = {
  ...
  budgetLoadingHint: "We're querying the cost engine and live market prices.",
  budgetLoadingProgress: "Progress",
  budgetLoadingEta: "About {seconds}s remaining",
  budgetLoadingAlmostDone: "Almost done…",
  budgetLoadingStepSim: "Preparing structural simulation…",
  budgetLoadingStepSupplies: "Quoting supplies and materials…",
  budgetLoadingStepNormativa: "Validating design compliance…",
  budgetLoadingStepSimShort: "Structural simulation",
  budgetLoadingStepSuppliesShort: "Supplies and market prices",
  budgetLoadingStepNormativaShort: "Compliance check",
