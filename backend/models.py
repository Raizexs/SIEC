...
class PrecioMercado(Base):
    ...
    # SCRUM-123: unidad explícita en que está expresado el precio almacenado.
    # Valores válidos: "saco 25kg", "unidad", "m²", "m³", "barra 6m",
    # "plancha 1.22x2.44m", "caja 100un", "galón 4L", "rollo 100m", "tubo 3m".
    # NULL significa que la unidad aún no ha sido declarada (se aplica fallback
    # usando la unidad_medida del Insumo asociado).
    unidad_precio = Column("Unidad_Precio", String, nullable=True)
