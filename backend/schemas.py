...
class InsumoCalculado(BaseModel):
    ...
    # SCRUM-123: unidad en que está expresado precio_unitario (ej. "saco 25kg", "m\u00b2", "unidad")
    unidad_precio: Optional[str] = None
    # SCRUM-123: True cuando no existe precio cargado en BD para este insumo
    sin_cotizacion: bool = False
